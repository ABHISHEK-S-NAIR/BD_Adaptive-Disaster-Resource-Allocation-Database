...
INSERT INTO app_users (id, username, display_name, role_id, contact_email) VALUES
  (1, 'aishwarya', 'Aishwarya Rao', 1, 'aishwarya@relieflab.org'),
  (2, 'mohit', 'Mohit Verma', 2, 'mohit@relieflab.org'),
  (3, 'leena', 'Leena Joseph', 3, 'leena@relieflab.org');
